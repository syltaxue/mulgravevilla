          ...
          return (
                <div id="Home" className="relative text-white font-bebas home-margin">
                      ...
                      <div className="absolute bottom-12 right-5 lg:bottom-24 lg:right-20 z-10">
                            <div className="relative">
                              <div className="absolute -top-10 right-3 md:top-6 md:right-6 lg:top-12 lg:right-12 z-30 whitespace-nowrap">
                                    <p className="lg:text-xlarge text-regularView-xlarge">IN WEST</p>
                                    <p className="lg:text-regular text-regularView-regular">VANCOUVER</p>
                              </div>
                              <div className="absolute bg-mulgrave-gray h-20 w-64 md:h-28 md:w-96 lg:h-56 lg:w-192 z-20"></div>
                            </div>
                      </div>
                </div>
                )
